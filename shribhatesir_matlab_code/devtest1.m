...
%    [alls1 alls2 alls3 ss1 ss2 ss3 ] 
   
   if alls1 < 74
       set(lable_left,'Background',[0 1 0.0]);  
       xl = 1 ; 
   elseif alls1 > 78 & alls1 < 83
...
%                 fa=vrnode(myw,'firstarm');
               ...
               w11=fa.rotation;
                if xl==1
                    w11(4) = w11(4) + 0.1;
                     ...
                     fa.rotation=[1 w11(2) w11(3) w11(4)];
                elseif xl==2
                    w11(4) = w11(4) - 0.1;  
                         if w11(4) < 0 
                              w11(4)= 0;
                ...
                if yl==1
                    ...
                    w11(4) = w11(4) + 0.1;
                     ...
                     fa.rotation=[w11(1)  1  w11(3) w11(4)];
                elseif yl==2
                      w11(4) = w11(4) - 0.1;  
                         if w11(4) < 0 
                              w11(4)= 0;
   ...
   % vrdrawnow
    pause(0.01)
    clear pt1 pt2 alls1 alls2 alls3 ss1 ss2 ss3  c2 a a1 a2 
    end
       pause(0.01)
    end
